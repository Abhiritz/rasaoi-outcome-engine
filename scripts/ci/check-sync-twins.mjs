/**
 * ROE-022 T1 / ROE-025 — Fail CI when sync-pair twins drift.
 *
 * Pairs:
 ...
 *   src/lib/scoreWeights.ts ↔ supabase/functions/_shared/score-weights.ts
...
const PAIRS = [
  ...
  {
    label: "score-weights",
    left: "src/lib/scoreWeights.ts",
    right: "supabase/functions/_shared/score-weights.ts",
    kind: "ts",
  },
  {
    label: "mock-places",
