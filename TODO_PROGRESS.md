...
**Status:** **Staging live** — Ask verified on https://rasaoi-i8.vercel.app  
**Branches:** `staging` + `feature/ROE-016-experimental-infra` (tip `592093d`)  
...
**Merge:** develop still **locked** (sim ≥98% met; formal plate soak + approval remaining)
